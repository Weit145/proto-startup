...
type AuthClient interface {
	...
	PasswordRequest(ctx context.Context, in *Email, opts ...grpc.CallOption) (*Empty, error)
	PasswordConfirm(ctx context.Context, in *PasswordConfirmRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *authClient) RefreshToken(ctx context.Context, in *RefreshRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
func (c *authClient) PasswordRequest(ctx context.Context, in *Email, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Auth_PasswordRequest_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *authClient) PasswordConfirm(ctx context.Context, in *PasswordConfirmRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
	err := c.cc.Invoke(ctx, Auth_PasswordConfirm_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	PasswordRequest(context.Context, *Email) (*Empty, error)
	PasswordConfirm(context.Context, *PasswordConfirmRequest) (*Empty, error)
...
func (UnimplementedAuthServer) RefreshToken(context.Context, *RefreshRequest) (*AuthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RefreshToken not implemented")
}
func (UnimplementedAuthServer) PasswordRequest(context.Context, *Email) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method PasswordRequest not implemented")
}
func (UnimplementedAuthServer) PasswordConfirm(context.Context, *PasswordConfirmRequest) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method PasswordConfirm not implemented")
}
...
func _Auth_CheckHealth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).CheckHealth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_CheckHealth_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).CheckHealth(ctx, req.(*Empty))
	}
...
func _Auth_PasswordRequest_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Email)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).PasswordRequest(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_PasswordRequest_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).PasswordRequest(ctx, req.(*Email))
	}
	return interceptor(ctx, in, info, handler)
}

func _Auth_PasswordConfirm_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PasswordConfirmRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServer).PasswordConfirm(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Auth_PasswordConfirm_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).PasswordConfirm(ctx, req.(*PasswordConfirmRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Auth_CheckHealth_Handler,
		},
		{
			MethodName: "Register",
		...
		{
			MethodName: "PasswordRequest",
			Handler:    _Auth_PasswordRequest_Handler,
		},
		{
			MethodName: "PasswordConfirm",
			Handler:    _Auth_PasswordConfirm_Handler,
		},
	},
