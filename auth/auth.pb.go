...
var file_auth_auth_proto_depIdxs = []int32{
	...
	0, // 4: auth.Auth.CheckHealth:output_type -> auth.Health
	5, // 5: auth.Auth.Register:output_type -> auth.AuthResponse
	5, // 6: auth.Auth.Login:output_type -> auth.AuthResponse
