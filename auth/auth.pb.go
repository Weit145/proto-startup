...
const file_auth_auth_proto_rawDesc = "" +
	...
	".auth.UserR\x04user2g\n" +
	"\x04Auth\x12(\n" +
	"\vCheckHealth\x12\v.auth.Empty\x1a\f.auth.Health\x125\n" +
	"\bRegister\x12\x15.auth.RegisterRequest\x1a\x12.auth.AuthResponseB,Z*github.com/Weit145/proto-startup/auth;authb\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	...
	0, // 3: auth.Auth.CheckHealth:output_type -> auth.Health
	4, // 4: auth.Auth.Register:output_type -> auth.AuthResponse
